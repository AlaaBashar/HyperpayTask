...
import 'bloc_main/main_states.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  builder: (context, state) {
    return Scaffold(
      appBar: AppBar(backgroundColor: ColorsHelper.DARK_VIOLET,),
                                                    ...
                                                    children: [
                                                      ...
                                                      MaterialButton(
                                                        onPressed:
                                                            () {
                                                          try {
                                                            Clipboard.setData(ClipboardData(text: shortlyDBList![index].shortlyLink))
                                                                .then(
                                                                    (value) {
                                                                  final snackBar =
                                                                  SnackBar(
                                                                    content:
                                                                    Text('Copied the short link'),
                                                                    action:
                                                                    SnackBarAction(
                                                                      label:
                                                                      'Undo',
  ...
  void onShorten() {
    ...
    if (url.isEmpty) {
      ...
      final snackBar = SnackBar(
        content: Text('The link is shorten'),
